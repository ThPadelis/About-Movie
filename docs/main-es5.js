...
var MovieCarouselComponent = /** @class */ (function () {
    function MovieCarouselComponent() {
        this.imagePath = "https://image.tmdb.org/t/p/original";
    }
    MovieCarouselComponent.prototype.ngOnInit = function () { };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var MovieCarouselModule = /** @class */ (function () {
    function MovieCarouselModule() {
    }
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(movieService) {
        this.movieService = movieService;
    }
    NavbarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.movieService.getGenres().subscribe(function (g) { return (_this.genres = g.genres); });
    };
...
var PersonCardComponent = /** @class */ (function () {
    ...
    PersonCardComponent.ctorParameters = function () { return [
...
var NumArrayPipe = /** @class */ (function () {
    function NumArrayPipe() {
    }
    NumArrayPipe.prototype.transform = function (value) {
        var rating = Math.trunc(value);
        var numbers = [];
...
var TruncatePipe = /** @class */ (function () {
    ...
    TruncatePipe.prototype.transform = function (text, length, extension) {
...
var MovieService = /** @class */ (function () {
    ...
    MovieService.prototype.getTrending = function () {
    ...
    MovieService.prototype.getImages = function (id) {
        return this.http.get(this.baseUrl + "/movie/" + id + "/images", this.params);
    };
    MovieService.prototype.getCredits = function (id) {
...
var PersonService = /** @class */ (function () {
    ...
    PersonService.prototype.getDetails = function (id) {
...
var SeoService = /** @class */ (function () {
    ...
    SeoService.prototype.setTitle = function (pageTitle) {
...
var MovieComponent = /** @class */ (function () {
    function MovieComponent(movieService, ngxService, router, sanitizer, seoService) {
        this.movieService = movieService;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.movieService
                                .getMovie(Number(this.router.snapshot.paramMap.get("id")))
                                .subscribe(function (m) {
                                _this.movie = m;
                                _this.seoService.setTitle(m.title);
                            })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.movieService
                                ...
                                _this.videos = v.results;
                                _this.videoUrl = _this.sanitizer.bypassSecurityTrustResourceUrl("https://www.youtube.com/embed/" + v.results[0].key + "?controls=0");
                            })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.movieService
                                ...
                                _this.backdrops = images.backdrops;
                                _this.posters = images.posters;
                            })];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.movieService
...
var MoviesComponent = /** @class */ (function () {
    function MoviesComponent(movieService, ngxService, seoService) {
        this.movieService = movieService;
        this.ngxService = ngxService;
        this.seoService = seoService;
    }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.movieService
                                .getPopular()
                                .subscribe(function (m) { return (_this.movies = m.results); })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.movieService
                                .getUpcoming()
                                .subscribe(function (m) { return (_this.upcoming = m.results[_this.randomInt(0, 20)]); })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.movieService
                                .getTrending()
                                .subscribe(function (m) { return (_this.trending = m.results.slice(0, 4)); })];
                    case 3:
                        _a.sent();
                        this.ngxService.stop();
                        return [2 /*return*/];
    ...
    MoviesComponent.prototype.randomInt = function (min, max) {
...
var PersonComponent = /** @class */ (function () {
    function PersonComponent(personService, ngxService, router, seoSercive) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.ngxService.start();
                        return [4 /*yield*/, this.personService
                                .getDetails(Number(this.router.snapshot.paramMap.get("id")))
                                .subscribe(function (p) {
                                _this.person = p;
                                _this.seoSercive.setTitle(p.name);
                            })];
                    case 1:
                        _a.sent();
                        this.ngxService.stop();
